    ...
    <main class="login-container" data-aos="fade-right" data-aos-delay="800">
        <div class="container">
            <div class="row page-login d-flex align-items-center">
            <div class="section-left col-12 col-md-6">
                <h1 class="mb-4">We explore the new <br />life much better</h1>
                <img
                src="/frontend/images/login.png"
                alt=""
            ...
            <div class="section-right col-12 col-md-5">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('home') }}">
                        <img src="{{ url('frontend/images/logo_pentorch14.png') }}" alt="Logo PENTORCH" class="w-50 mb-4"/>
                    </a>
                        {{-- <img
                        src="/frontend/images/logo_pentorch14.png"
                        alt=""
                        class="w-50 mb-4"
                    /> --}}
                    </div>
