    ...
    <main>
      ...
      <section class="section-details-content">
        <div class="container">
          ...
          <div class="row">
                    <div class="col-lg-8 pl-lg-0" data-aos="zoom-in" data-aos-duration="800">
                        <div class="card card-details">
                            ...
                            <p>
                              ...
                              @endif
                                <h2 data-aos="fade-up" data-aos-duration="100" data-aos-delay="250">
                                  Tentang Wisata
                                </h2>
                                <p data-aos="fade-up" data-aos-duration="100" data-aos-delay="250">
                                    {!! $item->about !!}
                                </p>
                                <div class="features row pt-3" data-aos="fade-up" data-aos-duration="100" data-aos-delay="200">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4 border-left" data-aos="fade-up" data-aos-duration="100" data-aos-delay="200">
                            ...
                            <h2>Trip Information</h2>
                                <table class="trip-informations">
                                  <tr>
                                    ...
                                    {{ \Carbon\Carbon::create($item->date_of_daparture)->format('F n, Y') }}
                                    </td>
                                  </tr>
                                  <tr>
